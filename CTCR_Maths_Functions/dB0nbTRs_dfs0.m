...
% mem_dR0_dfs0  : Matrix memory of the dR0(s)_df(s0) partial derivatives
% mem_dti_dfs0  : Matrix memory of the dti(s)_df(s0) partial derivatives


% ====================
% ===== OUTPUTS ====== 

% dB0nbTRsdfs0  : Value of the partial derivative
