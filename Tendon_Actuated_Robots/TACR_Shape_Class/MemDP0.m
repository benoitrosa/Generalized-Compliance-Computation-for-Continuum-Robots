...
%
% mem_dp0_dn0       : (3 x 3 x nbP) Matrix containing the partial derivatives w.r.t. n0(0)
%                     | mem_dp0_dn0(i,j,is)
%                     with
...
%
% mem_dp0_dm0       : (3 x 3 x nbP) Matrix containing the partial derivatives w.r.t. m0(0)
%                     | same template than mem_dp0_dn0
%
% mem_dp0_dti       : (3 x nbT x nbP) Matrix containing the partial derivatives w.r.t. ti
%                     | mem_dp0_dti(i,j,is)
%                     with
%                     | i ∊ [1 , 3]     : the component X/Y/Z of p0(s)
    ...
    methods
        ...
        function mc = MemDP0(varargin)
            if nargin == 5
                ...
                mc.mem_dp0_dn0      = varargin{1} ;
                mc.mem_dp0_dm0      = varargin{2} ;
                mc.mem_dp0_dti      = varargin{3} ;
                mc.mem_dp0_dtaus0   = varargin{4} ;
                mc.mem_dp0_dfs0     = varargin{5} ;
                
            end
        end

        % ====== Get all ======
        function [mem_dp0_dn0 , mem_dp0_dm0 , mem_dp0_dti , ...
                  mem_dp0_dtaus0 , mem_dp0_dfs0] = Get_All_MemDP0(mc)

            mem_dp0_dn0     = mc.mem_dp0_dn0    ;
            mem_dp0_dm0     = mc.mem_dp0_dm0    ;
            mem_dp0_dti     = mc.mem_dp0_dti    ;
