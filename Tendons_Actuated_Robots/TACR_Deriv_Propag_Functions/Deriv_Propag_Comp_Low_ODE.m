    ...
    if ~(is == tacr_construc.nbP)
        ...
        if simulation_param.bool_J
            ...
            for j = 1:tacr_carac.nbT
                ...
                mem_deriv_propag_low.mem_dR0_ds.mem_dR0_dti_ds(:,:,j,is)    = mem_deriv_propag_low.mem_dR0.mem_dR0_dti(:,:,j,is)*hat(mem_bvp.mem_y.mem_u0(:,is)) ...
        ...
        if simulation_param.bool_Cs0
            ...
            for tp_is0 = 1:length(pt_s0_LIT_curr)
                ...
                for j = 1:3
                    ...
                    mem_deriv_propag_low.mem_dR0_ds.mem_dR0_dtaus0_ds(:,:,j,is,is0) = mem_deriv_propag_low.mem_dR0.mem_dR0_dtaus0(:,:,j,is,is0)*hat(mem_bvp.mem_y.mem_u0(:,is)) ...
                                                                                      + mem_bvp.mem_y.mem_R0(:,:,is)*hat(mem_deriv_propag_low.mem_du0.mem_du0_dtaus0(:,j,is,is0)) ; 
                    
                    mem_deriv_propag_low.mem_dR0_ds.mem_dR0_dfs0_ds(:,:,j,is,is0)   = mem_deriv_propag_low.mem_dR0.mem_dR0_dfs0(:,:,j,is,is0)*hat(mem_bvp.mem_y.mem_u0(:,is)) ...
