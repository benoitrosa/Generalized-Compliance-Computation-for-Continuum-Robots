    ...
    if is >= ctcr_construc.ind_origin
        ...
        if is >= vect_ind_iT(ctcr_carac.nbT,3)
            ...
            for i = 1:length(curr_vectT)
                ...
                sum_R_Kzi   = sum_R_Kzi + rotz(mem_bvp.mem_y.mem_t(iT,is))*K(:,:,iT)*(ui_init(:,is,iT)) ;
        ...
        for j = 1:ctcr_carac.nbT
            ...
            if is == ctcr_construc.nbP
                ...
                for iv = 1:length(curr_vectT)
                    ...
                    sum_duzj0   = sum_duzj0 ...
                                  + hat([0;0;1])*rotz(mem_bvp.mem_y.mem_t(i,is))*mem_deriv_propag_low.mem_dti.mem_dti_duzj0(i,j,is)*K(:,:,i)*ctcr_construc.ui_init(:,is,i) ;
        ...
        for j = 1:3
            ...
            if is == ctcr_construc.nbP
                ...
                for iv = 1:length(curr_vectT)
                    ...
                    sum_dm0j0   = sum_dm0j0 ...
                                  + hat([0;0;1])*rotz(mem_bvp.mem_y.mem_t(i,is))*mem_deriv_propag_low.mem_dti.mem_dti_dm0j0(i,j,is)*K(:,:,i)*ctcr_construc.ui_init(:,is,i) ;
                ...
                for iv = 1:length(curr_vectT)
                    ...
                    sum_dn0j0   = sum_dn0j0 ...
                                  + hat([0;0;1])*rotz(mem_bvp.mem_y.mem_t(i,is))*mem_deriv_propag_low.mem_dti.mem_dti_dn0j0(i,j,is)*K(:,:,i)*ctcr_construc.ui_init(:,is,i) ;
