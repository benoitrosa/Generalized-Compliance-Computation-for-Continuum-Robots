function ctcr_shape_def_jacob = Lin_Deform(mem_is0,delta_f0,ctcr_shape_init,ctcr_construc_init,mem_Cs0_init,bool_disp_terminal)
...
% ctcr_construc_init    : Robot features related to the model settings for the initial shape
% mem_Cs0_init          : The Generalized Compliance Matrix associated to the initial shape
%
% ====================
% ===== OUTPUTS ====== 
%
% ctcr_shape_def_jacob  : Deformed CTCR shape, due to the force variations, computed using the Generalized Compliance Matrix
%
% ======================================================================= %
% ======================================================================= %
