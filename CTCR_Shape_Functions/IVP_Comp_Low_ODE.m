...
% ======================================================================= %
    ...
    for j = 1:nbT
        ...
        mem_deriv_propag_low.mem_d00Rs_ds.mem_d00Rs_duzj0_ds(:,:,j,is)      = mem_deriv_propag_low.mem_d00Rs.mem_d00Rs_duzj0(:,:,j,is)*hat(u0) ...
    ...
    if is >= ctcr_construc.ind_origin
        ...
        for j = 1:3
            ...
            mem_deriv_propag_low.mem_d00Rs_ds.mem_d00Rs_dm0j0_ds(:,:,j,is)  = mem_deriv_propag_low.mem_d00Rs.mem_d00Rs_dm0j0(:,:,j,is)*hat(u0) ...
                                                                              + mem_bvp.mem_T(1:3,1:3,is)*hat(mem_deriv_propag_low.mem_du0.mem_du0_dm0j0(:,j,is)) ;
           
            mem_deriv_propag_low.mem_d00Rs_ds.mem_d00Rs_dn0j0_ds(:,:,j,is)  = mem_deriv_propag_low.mem_d00Rs.mem_d00Rs_dn0j0(:,:,j,is)*hat(u0) ...
