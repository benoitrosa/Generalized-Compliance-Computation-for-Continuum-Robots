...
%
% vect_tol          : (nbT+6 x 1)       Residual vector (b in the paper)
% norm_tol          : (float)           Norm of b (at the iteration k)
% clk_bvp           : (float) [s]       Computation time for BVP resolution
% Bu                : (nbT+6 x nbT+6)   Optimization jacobian Bu = ∂b/∂yu(0)
% nb_iter           : (int)             Number of iterations for convergence
% IC_opt            : (nbT+6 x 1)       Value of the guess yu(0) when the optimization has converged
%
% ======================================================================= %
% ======================================================================= %
